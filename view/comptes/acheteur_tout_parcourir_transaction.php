        ...
        <div class="row">
            <div class="col-12 column-height">
                <div class="section-column">
                    <form action="<?php echo BASE_URL.'/voyageur/comptes/tout_parcourir_transaction/'.$pseudo ?>" method="post" onsubmit="return validateForm()">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="box_article_accueil">
                    <figure>
                        <a href="<?php echo BASE_URL.'/voyageur/comptes/Item_transaction/'.$pseudo.','.$v->Photo ?>">
